# hyperreduction.ecsw.custom_nnls { #skrom.hyperreduction.ecsw.custom_nnls }
...
| Name | Description |
| --- | --- |
| [NNLSSolver](#skrom.hyperreduction.ecsw.custom_nnls.NNLSSolver) | Sequential bounded NNLS (non-negative least squares) solver. |
| [NNLS_termination](#skrom.hyperreduction.ecsw.custom_nnls.NNLS_termination) | Termination criteria for the NNLS solver. |

### NNLSSolver { #skrom.hyperreduction.ecsw.custom_nnls.NNLSSolver }
...
| Name | Description |
| --- | --- |
| [set_verbosity](#skrom.hyperreduction.ecsw.custom_nnls.NNLSSolver.set_verbosity) | Set the verbosity level. |
| [solve](#skrom.hyperreduction.ecsw.custom_nnls.NNLSSolver.solve) | Solve A x ≈ b with 0 ≤ x and b∈[rhs_lb, rhs_ub] by active‐set NNLS. |

##### set_verbosity { #skrom.hyperreduction.ecsw.custom_nnls.NNLSSolver.set_verbosity }
...
##### solve { #skrom.hyperreduction.ecsw.custom_nnls.NNLSSolver.solve }
...
### NNLS_termination { #skrom.hyperreduction.ecsw.custom_nnls.NNLS_termination }
