...
def _widget_header(title, subtitle, *, color="#3367d6", background="#f1f5ff", text="#17233f"):
    ...
    return widgets.HTML(
        ...
        <div style="
          ...
          <div style="font-weight: 700; font-size: 18px; color: {text};">
            {title}
          </div>
    ...
    *,
    ...
    def render(_=None):
        with output:
            ...
            display(DisplayHTML(f"<div style='margin: 2px 0 8px 0;'>{badges}</div>"))
