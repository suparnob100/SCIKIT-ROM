"""End-to-end ECSW hyper-reduction training.

TL;DR
-----
This module combines randomized SVD and bounded NNLS to compute sparse ECSW weights.

Notes
-----
It can reduce the constraint matrix, solve for nonnegative weights, and optionally plot training diagnostics.
"""
