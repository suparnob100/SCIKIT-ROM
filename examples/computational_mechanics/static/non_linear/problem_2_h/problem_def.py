...
class ProblemNonLinear(Problem):
    ...
    def hyper_rom_operators(self, u, param):
        ...
        self.residual_hyper = self.residual_hyper_red.assemble_weighted_ecsw(**kw)
        self.jac_hyper = self.jac_hyper_red.assemble_weighted_ecsw(**kw)
    ...
    def hyper_rom_solver_ecsw(self, cls, param):
        ...
        return newton_solver_rom(self.hyper_rom_operators, self.u0, param, tol=1e-3,
                    maxit=500,
                    alpha = 1.0)
