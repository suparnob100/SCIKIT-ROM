"""
Domain setup for 1-D heat conduction with Dirichlet BC and two-material region split.

This function builds a uniform line mesh, defines linear FE bases, identifies Dirichlet
boundary DOFs, computes free DOFs, partitions elements into two regions, and returns
all domain data as a dictionary.
"""
...
def domain_(
    ...
    nx = 2 ** factor
    mesh = MeshLine(np.linspace(0, rx, nx + 1))
